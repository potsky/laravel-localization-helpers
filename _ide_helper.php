...
namespace {
    ...
    class Blade extends \Illuminate\Support\Facades\Blade{
        ...
        public static function createMatcher($function){
            //Method inherited from \Illuminate\View\Compilers\BladeCompiler            
            return \GrahamCampbell\HTMLMin\Compilers\MinifyCompiler::createMatcher($function);
        }
        ...
        public static function createOpenMatcher($function){
            //Method inherited from \Illuminate\View\Compilers\BladeCompiler            
            return \GrahamCampbell\HTMLMin\Compilers\MinifyCompiler::createOpenMatcher($function);
        }
        ...
        public static function createPlainMatcher($function){
            //Method inherited from \Illuminate\View\Compilers\BladeCompiler            
            return \GrahamCampbell\HTMLMin\Compilers\MinifyCompiler::createPlainMatcher($function);
        }
    ...
    class DB extends \Illuminate\Support\Facades\DB{
        ...
        public static function getPaginator(){
            //Method inherited from \Illuminate\Database\Connection            
            return \Jenssegers\Mongodb\Connection::getPaginator();
        }
        ...
        public static function setPaginator($paginator){
            //Method inherited from \Illuminate\Database\Connection            
            \Jenssegers\Mongodb\Connection::setPaginator($paginator);
        }
        ...
        public static function getCacheManager(){
            //Method inherited from \Illuminate\Database\Connection            
            return \Jenssegers\Mongodb\Connection::getCacheManager();
        }
        ...
        public static function setCacheManager($cache){
            //Method inherited from \Illuminate\Database\Connection            
            \Jenssegers\Mongodb\Connection::setCacheManager($cache);
        }
    ...
    class Authorizer extends \LucaDegasperi\OAuth2Server\Facades\AuthorizerFacade{
        ...
        /**
         * The original method is available at $this->checker->getAccessToken()
         * I have rewritten this method here to get the access token even if it has expired for debug purpose
         *
         * @return \League\OAuth2\Server\Entity\AccessTokenEntity 
         * @static 
         */
        public static function getAccessToken(){
            return \Potsky\Service\OAuth2\Server\Authorizer::getAccessToken();
        }
        ...
        public static function getResourceOwnerId(){
            return \Potsky\Service\OAuth2\Server\Authorizer::getResourceOwnerId();
        }
        ...
        public static function getResourceOwnerType(){
            return \Potsky\Service\OAuth2\Server\Authorizer::getResourceOwnerType();
        }
        ...
        public static function getIssuer(){
            //Method inherited from \LucaDegasperi\OAuth2Server\Authorizer            
            return \Potsky\Service\OAuth2\Server\Authorizer::getIssuer();
        }
        ...
        public static function getChecker(){
            //Method inherited from \LucaDegasperi\OAuth2Server\Authorizer            
            return \Potsky\Service\OAuth2\Server\Authorizer::getChecker();
        }
        ...
        public static function issueAccessToken(){
            //Method inherited from \LucaDegasperi\OAuth2Server\Authorizer            
            return \Potsky\Service\OAuth2\Server\Authorizer::issueAccessToken();
        }
        ...
        public static function getAuthCodeRequestParams(){
            //Method inherited from \LucaDegasperi\OAuth2Server\Authorizer            
            return \Potsky\Service\OAuth2\Server\Authorizer::getAuthCodeRequestParams();
        }
        ...
        public static function getAuthCodeRequestParam($key, $default = null){
            //Method inherited from \LucaDegasperi\OAuth2Server\Authorizer            
            return \Potsky\Service\OAuth2\Server\Authorizer::getAuthCodeRequestParam($key, $default);
        }
        ...
        public static function checkAuthCodeRequest(){
            //Method inherited from \LucaDegasperi\OAuth2Server\Authorizer            
            return \Potsky\Service\OAuth2\Server\Authorizer::checkAuthCodeRequest();
        }
        ...
        public static function issueAuthCode($ownerType, $ownerId, $params = array()){
            //Method inherited from \LucaDegasperi\OAuth2Server\Authorizer            
            return \Potsky\Service\OAuth2\Server\Authorizer::issueAuthCode($ownerType, $ownerId, $params);
        }
        ...
        public static function authCodeRequestDeniedRedirectUri(){
            //Method inherited from \LucaDegasperi\OAuth2Server\Authorizer            
            return \Potsky\Service\OAuth2\Server\Authorizer::authCodeRequestDeniedRedirectUri();
        }
        ...
        public static function getRedirectUriGenerator(){
            //Method inherited from \LucaDegasperi\OAuth2Server\Authorizer            
            return \Potsky\Service\OAuth2\Server\Authorizer::getRedirectUriGenerator();
        }
        ...
        public static function setRedirectUriGenerator($redirectUri){
            //Method inherited from \LucaDegasperi\OAuth2Server\Authorizer            
            return \Potsky\Service\OAuth2\Server\Authorizer::setRedirectUriGenerator($redirectUri);
        }
        ...
        public static function validateAccessToken($httpHeadersOnly = false, $accessToken = null){
            //Method inherited from \LucaDegasperi\OAuth2Server\Authorizer            
            return \Potsky\Service\OAuth2\Server\Authorizer::validateAccessToken($httpHeadersOnly, $accessToken);
        }
        ...
        public static function getScopes(){
            //Method inherited from \LucaDegasperi\OAuth2Server\Authorizer            
            return \Potsky\Service\OAuth2\Server\Authorizer::getScopes();
        }
        ...
        public static function hasScope($scope){
            //Method inherited from \LucaDegasperi\OAuth2Server\Authorizer            
            return \Potsky\Service\OAuth2\Server\Authorizer::hasScope($scope);
        }
        ...
        public static function getClientId(){
            //Method inherited from \LucaDegasperi\OAuth2Server\Authorizer            
            return \Potsky\Service\OAuth2\Server\Authorizer::getClientId();
        }
        ...
        public static function setRequest($request){
            //Method inherited from \LucaDegasperi\OAuth2Server\Authorizer            
            return \Potsky\Service\OAuth2\Server\Authorizer::setRequest($request);
        }
        ...
        public static function setTokenType($tokenType){
            //Method inherited from \LucaDegasperi\OAuth2Server\Authorizer            
            return \Potsky\Service\OAuth2\Server\Authorizer::setTokenType($tokenType);
        }
    ...
    class DBG extends \Barryvdh\Debugbar\Facade{
    ...
    class LaravelLocalization extends \Mcamara\LaravelLocalization\Facades\LaravelLocalization{
        ...
        public static function negotiateLanguage(){
            return \Mcamara\LaravelLocalization\LaravelLocalization::negotiateLanguage();
        }
        ...
        public static function setLanguage($language = null){
            return \Mcamara\LaravelLocalization\LaravelLocalization::setLanguage($language);
        }
         ...
         * @static 
         */
        public static function getLanguageBar($abbr = false, $customView = 'mcamara/laravel-localization/languagebar'){
            return \Mcamara\LaravelLocalization\LaravelLocalization::getLanguageBar($abbr, $customView);
        }
         ...
         * @static 
         */
        public static function getURLLanguage($language, $route = null){
            return \Mcamara\LaravelLocalization\LaravelLocalization::getURLLanguage($language, $route);
        }
         ...
         * @static 
         */
        public static function getCleanRoute($route = null){
            return \Mcamara\LaravelLocalization\LaravelLocalization::getCleanRoute($route);
        }
        ...
        public static function getDefault(){
            return \Mcamara\LaravelLocalization\LaravelLocalization::getDefault();
        }
        ...
        public static function getAllowedLanguages(){
            return \Mcamara\LaravelLocalization\LaravelLocalization::getAllowedLanguages();
        }
        ...
        public static function getSupportedLanguages(){
            return \Mcamara\LaravelLocalization\LaravelLocalization::getSupportedLanguages();
        }
        ...
        public static function getCurrentLanguageDirection(){
            return \Mcamara\LaravelLocalization\LaravelLocalization::getCurrentLanguageDirection();
        }
         ...
         * @static 
         */
        public static function getCurrentLanguageScript(){
            return \Mcamara\LaravelLocalization\LaravelLocalization::getCurrentLanguageScript();
        }
         ...
         * @static 
         */
        public static function getLanguageBarClassName(){
            return \Mcamara\LaravelLocalization\LaravelLocalization::getLanguageBarClassName();
        }
         ...
         * @static 
         */
        public static function getPrintCurrentLanguage(){
            return \Mcamara\LaravelLocalization\LaravelLocalization::getPrintCurrentLanguage();
        }
        ...
        public static function getCurrentLanguage(){
            return \Mcamara\LaravelLocalization\LaravelLocalization::getCurrentLanguage();
        }
    ...
    class GeoIP extends \Potsky\Service\GeoIP\GeoIPFacade{
        ...
        public static function saveLocation(){
            \Potsky\Service\GeoIP\GeoIP::saveLocation();
        }
        ...
        public static function getLocation($ip = null){
            return \Potsky\Service\GeoIP\GeoIP::getLocation($ip);
        }
